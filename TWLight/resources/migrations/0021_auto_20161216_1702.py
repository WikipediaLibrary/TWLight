...
class Migration(migrations.Migration):
    ...
    dependencies = [("resources", "0020_move_to_internal_durationfield")]
    ...
    operations = [
        ...
        migrations.AlterField(
            ...
            field=models.DurationField(
                ...
                help_text="The standard length of an access grant from this Partner. Entered as <days hours:minutes:seconds>. Defaults to 365 days.",
                null=True,
                blank=True,
            ),
        ),
