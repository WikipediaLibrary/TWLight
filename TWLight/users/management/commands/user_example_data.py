...
class Command(BaseCommand):
    help = "Superuser the only user, then add a number of example users and coordinators."
    ...
    def handle(self, *args, **options):
        ...
        for user in all_users:
            date_valid = datetime.today().date() - timedelta(days=182) >= user.editor.wp_registered
