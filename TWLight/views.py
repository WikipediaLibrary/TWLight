    ...
    def get_context_data(self, **kwargs):
        ...
        * a datetime
        ...
        for editor in editors:
            ...
            # fmt: off
            # Translators: This displays on the timeline when a new user registers. Don't translate {username}. Translate Wikipedia Library in the same way as the global branch is named (click through from https://meta.wikimedia.org/wiki/The_Wikipedia_Library).
        ...
        for partner in partners:
            ...
            # Translators: This displays on the timeline when a new partner is added. Don't translate {partner}. Translate Wikipedia Library in the same way as the global branch is named (click through from https://meta.wikimedia.org/wiki/The_Wikipedia_Library).
