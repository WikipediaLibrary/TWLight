...
docker build --cache-from "twlight_base" --cache-from "twlight_build" --target twlight_build --tag "wikipedialibrary/twlight_build:${TRAVIS_BRANCH}" .
docker build --cache-from "twlight_base" --cache-from "twlight_build"  --tag "wikipedialibrary/twlight:${TRAVIS_BRANCH}" .
